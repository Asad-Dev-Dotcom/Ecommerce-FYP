...
const CategoryCard = ({ category, onEdit, onDelete }) =>
{
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md hover:-translate-y-1 transition-all duration-200">
      ...
      <div className="p-5">
        <h3 className="text-xl font-semibold text-gray-900 m-0 mb-2">{category.title || category.name}</h3>
        <p className="text-gray-600 text-sm mb-4 line-clamp-2">{category.description}</p>

        <div className="flex justify-between items-center mb-4">
          <div className="text-center">
            <span className="text-xs text-gray-500 uppercase font-medium block">Status</span>
            <span className="text-lg font-bold text-gray-800">Active</span>
          </div>
          <div className="text-center">
